...
class MySearchCrew():
	...
	try:
		...
		myllm_mixtral = LLM(api_key="fsdf", model="mistralai/mistral-small-3.2",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=18000, frequency_penalty=2.0)
