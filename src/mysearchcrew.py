...
class MySearchCrew():
	...
	def my_reporter_stepCallback(self, output: Task):
		...
		#if agent finish or agent action or Toolresult
	try:
		myllm_llama3_8b = LLM(api_key="fsdf", model="openai/meta-llama-3.1-8b-instruct",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=12000, seed=42)
		...
		myllm_gemma2 = LLM(api_key="fsdf", model="openai/gemma-2-9b-it",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=0, seed=42)
		# myllm_gemma2 = LLM(api_key="fsdf", model="openai/gemma-2-27b",  base_url="http://localhost:1234/v1", temperature=0.7, max_tokens=0)
		myllm_r1_d_qwen = LLM(api_key="fsdf", model="openai/deepseek-r1-distill-qwen-32b-mlx",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=12000, seed=42)
		myllm_r1_d_llama = LLM(api_key="fsdf", model="openai/deepseek-r1-distill-llama-8b",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=12000, seed=42)
		...
		myllm_granite = LLM(api_key="fsdf", model="openai/granite-3.2-8b-instruct",  base_url="http://localhost:1234/v1", temperature=0.0, max_tokens=18000, seed=42)
